      ...
      return (
        <React.Fragment>
          ...
          <Form>
            ...
            <Input name='stdname' type='text' ref='stdname' label='Student Name' />
            <Input name='stdfname' type='text' ref='stdfname' label='Student Family Name' />
            <Input name='stdrand' type='number' ref='stdrand' label='Student Rand' />
          </Form>
