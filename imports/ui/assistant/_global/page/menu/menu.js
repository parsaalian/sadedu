        ...
        <div style={{position: "fixed", zIndex: "100", width: "100%", boxShadow: "0 1px 2px 0 rgba(34,36,38,.15)"}}>
          <Menu className="rtl" defaultSelectedKeys={[this.props.history.location.pathname.replace("/assistant", "")]} mode="horizontal" style={{ lineHeight: "64px" }}>
            ...
            <Menu.Item className="float-right" key="/students" onClick={this.onClick}>
              ...
              <span style={{fontFamily: "iransans", fontWeight: "600"}}>دانشجویان</span>
            </Menu.Item>
            ...
            <Menu.SubMenu
              ...
              title={
                <React.Fragment>
                  <Avatar size="large" style={{backgroundColor: "#00a2ae" }}><Icon style={{ margin: 0, position: "relative", top: "-3px" }} type="user" /></Avatar>
